...
##  Proje Yapısı ve Katmanlı Mimari (N-Tier)
...
### 2.  TimeSpace.DataAccess (Veri Erişim Katmanı)
...
### 4.  TimeSpace (Sunum/Arayüz Katmanı - UI)
...
##  Veritabanı Şeması (ChronoTaleDB)
...
---
>  **ÖNEMLİ (API KEY)** > Projenin GitHub reposunda güvenlik politikaları gereği **Stable Diffusion API Anahtarı** gizlenmiştir. 
